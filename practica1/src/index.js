// Constantes de configuración del puerto por el que se ejecutara el proyecto
const express = require('express')
const app = express()                       
const port = process.env.PORT || 3000      //puerto predefinido de el servidor


const userRoute = require('./routes/user') //ruta del usuario
...
mongoose
    .connect(process.env.MODB_CONNECTION_STRING_ONG)
